...
わかりやすい漫画を作るには、漫画家本人が「実際にその技術を使い、たくさんつまずいて、ナルホドと感動する瞬間」を通過する必要があるのです。
 ...
 * D. 絵心があるエンジニアが、漫画のネーム、図解イラストの下書きまで手掛ける。漫画家は絵の仕上げに徹する
 * E. 2人の間にめちゃくちゃにディレクションが上手い編集担当がジョインする
...
Dパターンは、経験したことがありません。この方法で作ったよ！という方がいたら、興味あるので @llminatoll にTwitterでDMしてください。

Eパターンは、編集さん自体に国宝級のディレクション能力 + 技術の勘所 が必須だと思われます。この方式はトレンドプロさんが見事に実現されていると思います。
...
2017年春に、第2回目が開かれるということで、技術書典2から出展することにしました。同人誌のイベントに出るのはこれが初めてでした。
